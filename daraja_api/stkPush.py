...
def initiate_stk_push(amount, phone):
    breakpoint()


    if amount is None or phone is None:
        return JsonResponse({'error': 'Amount and phone are required parameters.'}, status=400)
    ...
    if isinstance(access_token_response, JsonResponse):
        ...
        if access_token:
            ...
            stk_push_payload = {
                ...
                'PhoneNumber': party_a,
                'CallBackURL': 'https://7f7b-41-80-113-70.ngrok.io/daraja_api/callback',
                'AccountReference': "etaka",
